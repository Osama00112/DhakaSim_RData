...
data_high_density_without_objects$sp_car <- convert_to_minutes(data_high_density_without_objects$sp_car)
data_with_objects_moderate_density$sp_car <- convert_to_minutes(data_with_objects_moderate_density$sp_car)
data_with_objects_high_density$sp_car <- convert_to_minutes(data_with_objects_high_density$sp_car)
data_moderate_density_without_objects$sp_car <- convert_to_minutes(data_moderate_density_without_objects$sp_car)

# Extract `sp_car` data
sp_car_high_density_without_objects <- data_high_density_without_objects$sp_car
sp_car_with_objects_moderate_density <- data_with_objects_moderate_density$sp_car
sp_car_with_objects_high_density <- data_with_objects_high_density$sp_car
sp_car_moderate_density_without_objects <- data_moderate_density_without_objects$sp_car

# Manually input real-time data (converted to minutes)
real_time_avg_moderate <- 23.5  # Replace with actual value
real_time_var_moderate <- (100 / 60)^2  # Replace with actual value
real_time_avg_high <- 32       # Replace with actual value
...
stats_moderate_without_objects <- calculate_stats(sp_car_moderate_density_without_objects)
stats_with_objects_moderate <- calculate_stats(sp_car_with_objects_moderate_density)
stats_high_without_objects <- calculate_stats(sp_car_high_density_without_objects)
stats_with_objects_high <- calculate_stats(sp_car_with_objects_high_density)
