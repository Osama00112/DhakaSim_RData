...
data_high_density_without_objects$ps_car <- convert_to_minutes(data_high_density_without_objects$ps_car)
data_with_objects_moderate_density$ps_car <- convert_to_minutes(data_with_objects_moderate_density$ps_car)
data_with_objects_high_density$ps_car <- convert_to_minutes(data_with_objects_high_density$ps_car)
data_moderate_density_without_objects$ps_car <- convert_to_minutes(data_moderate_density_without_objects$ps_car)

# Extract `ps_car` data
ps_car_high_density_without_objects <- data_high_density_without_objects$ps_car
ps_car_with_objects_moderate_density <- data_with_objects_moderate_density$ps_car
ps_car_with_objects_high_density <- data_with_objects_high_density$ps_car
ps_car_moderate_density_without_objects <- data_moderate_density_without_objects$ps_car
...
stats_moderate_without_objects <- calculate_stats(ps_car_moderate_density_without_objects)
stats_with_objects_moderate <- calculate_stats(ps_car_with_objects_moderate_density)
stats_high_without_objects <- calculate_stats(ps_car_high_density_without_objects)
stats_with_objects_high <- calculate_stats(ps_car_with_objects_high_density)
