...
data_high_density_without_objects$ps_bike <- convert_to_minutes(data_high_density_without_objects$ps_bike)
data_with_objects_moderate_density$ps_bike <- convert_to_minutes(data_with_objects_moderate_density$ps_bike)
data_with_objects_high_density$ps_bike <- convert_to_minutes(data_with_objects_high_density$ps_bike)
data_moderate_density_without_objects$ps_bike <- convert_to_minutes(data_moderate_density_without_objects$ps_bike)

# Extract `ps_bike` data
ps_bike_high_density_without_objects <- data_high_density_without_objects$ps_bike
ps_bike_with_objects_moderate_density <- data_with_objects_moderate_density$ps_bike
ps_bike_with_objects_high_density <- data_with_objects_high_density$ps_bike
ps_bike_moderate_density_without_objects <- data_moderate_density_without_objects$ps_bike
...
stats_moderate_without_objects <- calculate_stats(ps_bike_moderate_density_without_objects)
stats_with_objects_moderate <- calculate_stats(ps_bike_with_objects_moderate_density)
stats_high_without_objects <- calculate_stats(ps_bike_high_density_without_objects)
stats_with_objects_high <- calculate_stats(ps_bike_with_objects_high_density)
